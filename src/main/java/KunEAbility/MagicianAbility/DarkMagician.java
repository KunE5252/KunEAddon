...
public class DarkMagician extends AbilityBase implements ActiveHandler {
    public static final AbilitySettings.SettingObject<Integer> RIGHT_CLICK_COOLDOWN_CONFIG = KunAddon.KunEMagicWarAbility.new SettingObject<Integer>(DarkMagician.class, "RIGHTCLICK_COOLDOWN", 80,
            "# 우클릭 쿨타임") {
